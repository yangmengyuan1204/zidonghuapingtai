...
function main() {
  ...
  if (!/RequirementVerificationView\.vue/.test(router)) issues.push('requirementVerification native route must remain unchanged')
  if (!(config.migrated || []).includes('requirementVerification')) issues.push('migration-config missing requirementVerification')
