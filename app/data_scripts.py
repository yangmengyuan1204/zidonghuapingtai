...
ORDER_OPTION_NAME_FALLBACKS = {
    ...
    "取布标": "取布标",
    "缝布标": "缝布标",
    # 订单 optionList 接口返回的 option 补齐（按 id 与 name 去重，已有的不重复添加）
    "78": "详细检品",
    "79": "针检",
    "80": "X线针检",
    "81": "X线针检往返运费",
    ...
    "贴尺码标": "贴尺码标",
    "换货普检收费": "换货普检收费",
    # optionList 接口 name_translate（日文名）作为 key 补齐（按 name 去重，已有的不重复添加）
    "商品ラベル貼り付け": "FBA贴标",
    "詳細検品": "详细检品",
    "通常検針サービス": "针检",
    "通常OPP袋入れ替え": "更换OPP袋子",
    "X線検針サービス": "X线针检",
    "X線検針会社までの国内往復送料": "X线针检往返运费",
    "織りネーム作成": "做布标",
    "織りネーム外し": "取布标",
    "下げ札取り外し": "取吊牌",
    "織りネーム縫い付け": "缝布标",
    ...
    "アイロン掛け": "熨烫",
    "下げ札取り付け": "挂吊牌",
    "別注折りたたみパッケージへの入替": "更换定制包装",
    "LOGOシール作成": "做贴纸",
    "クッション包装": "水晶棉包装",
    "LOGOシール貼り付け": "贴贴纸",
    "角折りopp梱包": "opp袋子四角包装",
    "圧縮包装*圧縮袋別途費用": "压缩包装操作费",
    "チラシ、感謝手紙など印刷物入れ(1種類のみ)": "放感谢信/卡片(限一张)",
    "圧縮袋": "压缩袋费用",
    "検針サービス（大型バッグ）": "磁性针检（大型包）",
    "検針サービス（小型バッグ）": "磁性针检（小型包）",
    "シュリンク包装": "塑封",
    "圧縮包装（袋別途費用）": "真空压缩",
    "通電検査": "通电检品",
    "洗濯表示タグ製作": "制作水洗标",
