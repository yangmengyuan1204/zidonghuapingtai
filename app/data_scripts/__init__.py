...
from .payment_amount_regression.runner import run_payment_amount_regression_script
...
from .rollback_flow import ROLLBACK_TARGET_LABELS, run_rollback_flow_script
...
register_script("rollback_flow", run_rollback_flow_script)
...
register_script("payment_amount_regression", run_payment_amount_regression_script)
