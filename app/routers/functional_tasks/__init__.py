...
from ...services.functional_execution_service import (
    _background_execute_functional,
    _build_functional_repair_plan,
    _classify_functional_execution_result,
    _execution_event,
    _functional_execution_payload,
    _repair_issue_type,
    _save_functional_runtime_variables,
    execute_functional_case_for_run,
    execute_functional_case_for_run_isolated,
    save_functional_run,
)
from ...services.functional_requirement_service import (
    _prepare_requirement_package,
